### Hello World! 👋
#### A Backend Developer and Project Developer
<!--
**sergiosteevens/sergiosteevens** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
<!--
<iframe src="" width="480" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
...
están en desarrollo:
## 📊 Data Analysis / Data Science / Data Engineering (CAL, ALG, PRO, STA)(Work in Progress)...
| Distribución | Uso común | Proyecto ejemplo |
|--------------|-----------|------------------|
| Binomial     | Conversión de clientes | [Repositorio](link) |
| Normal       | Detección de anomalías | [Repositorio](link) |
| Dirichlet    | Modelado de temas (LDA) | [Repositorio](link) |
